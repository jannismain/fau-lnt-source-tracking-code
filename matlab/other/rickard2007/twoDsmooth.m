...
%
% MAT i s the 2D matrix to be smoothed.
% KER is either
% (1) a scalar , in which case a ker−by−ker matrix of 1/kerˆ2 is used as the matrix averaging kernel
% (2) a matrix which is used as the averaging kernel. SMAT is the smoothed matrix (same size as mat) .
