...
for iter = 1:20
    ...
    hold on
    line([cfg.theta_vec(length(cfg.theta_vec)-point(1)+1),cfg.theta_vec(length(cfg.theta_vec)-point(1)+1)],[0,1.2*max(psi(1,:))],'Color','r')
    line([cfg.theta_vec(length(cfg.theta_vec)-point(2)+1),cfg.theta_vec(length(cfg.theta_vec)-point(2)+1)],[0,1.2*max(psi(1,:))],'Color','r')
